...
public class Product : AuditableEntity, IAggregateRoot
{
    ...
    public static Product Create(string name, string? description, decimal price, Guid? brandId, string? baseUnit, decimal conversionFactor, string? bulkUnit)
    {
    ...
    public Product Update(string? name, string? description, decimal? price, Guid? brandId, string? baseUnit, decimal? conversionFactor, string? bulkUnit)
    {
    ...
    public static Product Update(Guid id, string name, string? description, decimal price, Guid? brandId, string? baseUnit, decimal conversionFactor, string? bulkUnit)
    {
        var product = new Product
        {
            Id = id,
